...
const EVENTS: Dictionary = {
	...
	"box_delivered": {
		...
		"lines": [
			...
			## 🚨 **ตัวเลือกปิดท้ายนี้คือตัวสั่งปิดแชท** — `chat_event_trigger.gd` เห็นว่า
			## บรรทัดสุดท้ายเป็น `"choices"` แล้วเก็บโทรศัพท์ให้เองหลังผู้เล่นกด
			## ลบออกเมื่อไหร่ = กลับไปเป็นแชทที่ต้องกด E/Esc ปิดเอง (ไม่พัง แค่เปลี่ยนพฤติกรรม)
			{"choices": ["รับทราบค่ะ"]},
		],
	},
}
